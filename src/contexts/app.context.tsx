...
export const AppProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [managedApiEnabled, setManagedApiEnabledState] =
  ...
  const loadData = () => {
    ...
    setManagedApiEnabledState(false);
  ...
  const setManagedApiEnabled = async (_enabled: boolean) => {
    setManagedApiEnabledState(false);
    safeLocalStorage.setItem(STORAGE_KEYS.MANAGED_API_ENABLED, "false");
