...
export const Audio = ({
  ...
  const { selectedSttProvider, managedApiEnabled, selectedAudioDevices } =
    useApp();
  ...
  return (
    <Popover open={micOpen} onOpenChange={setMicOpen}>
      <PopoverTrigger asChild>
        {(managedApiEnabled || speechProviderStatus) && enableVAD ? (
          <AutoSpeechVAD
      ...
      <PopoverContent
        ...
        side="bottom"
        className={`w-80 p-3 ${
          managedApiEnabled || speechProviderStatus ? "hidden" : ""
        }`}
        sideOffset={8}
      >
